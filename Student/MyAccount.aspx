...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="tbl">
        ...
        <tr>
            <td align="center">
                <asp:Button ID="Button12" runat="server" CssClass="btn" Text="Meus Dados" 
                    onclick="Button12_Click" />
&nbsp;<asp:Button ID="Button13" runat="server" CssClass="btn" Text="Editar Dados" 
                    onclick="Button13_Click" />
            &nbsp;<asp:Button ID="Button14" runat="server" CssClass="btn" Text="Alterar Senha" 
