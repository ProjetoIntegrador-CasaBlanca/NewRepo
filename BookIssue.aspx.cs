...
public partial class BookIssue : System.Web.UI.Page
{
    ...
    protected void btnissue_Click(object sender, EventArgs e)
    {
        try
        {
            if (TextBox1.Text == "")
            {
                lblissue.Text = "Insira a quant. de dias";
            }
            else
            {
                if (Convert.ToInt32(lblaqnt.Text) == 0)
                {
                    lblissue.Text = "Sem cópias deste livro no momento";
                }
                else
                {
                    ...
                    if (RDT.Rows.Count != 0)
                    {
                        lblissue.Text = "Usuário já tem o livro emprestado!";
                    }
                    else
                    {
                        ...
                        if (RDT.Rows.Count == 3)
                        {
                            lblissue.Text = "Apenas 3 livros emprestados por usuário";
                        }
                        else
                        {
                            ...
                            lblissue.Text = "Livro emprestado para " + drpstudent.SelectedItem.Text;
